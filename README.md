...
Проект поддерживает три среды разработки:

- **Dev** - для активной разработки с hot reload
...
```bash
# Запуск dev среды (рекомендуется для разработки)
...
- **Dev**: `http://dev.прибыл.рф` (с hot reload)
- **Staging**: `https://dev.прибыл.рф` (тестирование)
- **Production**: `https://прибыл.рф` (продакшн)

Подробная документация по средам: [ENVIRONMENTS.md](./ENVIRONMENTS.md)
